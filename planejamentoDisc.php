...
if(!empty($_GET)){
    ...
    $dados = listarPlanejamentosPorDP($_GET['i']);
           ...
           <div class="container">
               <form class="formularioCurso" action="services/curso.php" method="POST">
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                ...
                                <div class="list-group">
                                    ...
                                    <a class="list-group-item media" href="planejamentoDetail?i=<?php echo $dado->id ?>">
                                        <div class="pull-left">
                                            <img class="lgi-img" src="img/curso.png" alt="">
                                        </div>
                                        <div class="media-body">
                                            <div class="lgi-heading"><?php echo $dado->titulo ?></div>
                                            <small><?php echo $dado->data ?></small>
                                        </div>
                                    </a>
                                    ...
                                    <?php
                                            ...
                                            echo "Nenhum planejamento cadastrado";
                                        }
                                    ?>
                                </div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <a href="planejamentoNovo?i=<?php echo $disc_professor->id ?>" style="float: right" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Novo</a>
                    </div>
                </form>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">NOVO PLANEJAMENTO</h4>
                            </div>
