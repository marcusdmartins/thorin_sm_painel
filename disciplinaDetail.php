...
session_start();
ManagerSession::validaAcesso(20);
ManagerSession::setCookie();

if(!empty($_GET)){
    $dados = listarDisciplina($_GET['i']);
...
<body>
    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="fg-line form-group">
                                        ...
                                        <p><?php echo $dados->carga_horaria ?></p>
                                    </div>
                                </div> 
                                <div class="col-sm-6">  
                                    <div class="fg-line form-group">
                                        <label>Curso</label><br>
                                        <p><?php echo $dados->nome_curso." - ".$nivel->nome ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <a href="disciplinas" style="float: left" class="btn bgm-gray btn-icon-text"><i class="zmdi zmdi-arrow-back"></i> Voltar</a>
        ...
        <div class="modal fade" id="edit" role="dialog" aria-hidden="true" >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="formularioDisciplina" action="services/disciplina.php" method="POST">
                            ...
                            <div class="card-body card-padding">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="fg-line form-group">
                                            <label>Carga horaria</label>
                                            <input type="text" value="<?php echo $dados->carga_horaria ?>" class="form-control input-sm" data-mask="0000" name="carga_horaria" required="">
                                        </div>
                                    </div> 
                                    <div class="col-sm-6">  
                                        <div class="fg-line form-group">
    ...
    <script>
        ...
        function excl(id_disciplina){
            $.ajax({
                    type: "POST",
                    data: {i:id_disciplina, function:'remover'},
