...
<body>
    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
               <form class="formularioNivel" action="services/tipoAvaliacao.php" method="POST">
                    <input type="hidden" name="function" value="novo"/>
                    <div class="card">
                        <div class="card-header">
                            <h2>Novo Tipo de Avaliação</h2>
                        </div>
                        <div class="card-body card-padding">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="fg-line form-group">
                                        <input type="text" class="form-control input-sm" name="descricao" placeholder="Nome" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
