        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
               <form class="formularioNivel" action="services/nivel.php" method="POST">
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                ...
                                <div class="list-group">
                                    ...
                                    <a class="list-group-item media" href="nivelDetail?i=<?php echo $nivel->id ?>">
                                        <div class="pull-left">
                                            <img class="lgi-img" src="img/nivel.png" alt="">
                                        </div>
                                        <div class="media-body">
                                            <div class="lgi-heading"><?php echo $nivel->nome ?></div>
                    ...
                    <div class="card-body">
                        <a href="novoNivel" style="float: right" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Novo</a>
                    </div>
                </form>                
            </div>              
