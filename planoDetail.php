...
require_once 'services/planoAula.php';
...
<body>
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
               <form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="fg-line form-group">
                                        ...
                                        <p><?php echo formata_padrao_data($dados->data) ?></p>
                                    </div>
                                </div> 
                                <div class="col-sm-12">  
                                    <div class="fg-line form-group">
                    ...
                    <div class="card-body">
                        <a href="planoDisc?i=<?php echo $dados->dp ?>" style="float: left" class="btn bgm-gray btn-icon-text"><i class="zmdi zmdi-arrow-back"></i> Voltar</a>
        ...
        <div class="modal fade" id="edit" role="dialog" aria-hidden="true" >
            <div class="modal-dialog modal-lg">
               ...
               <form>
                   ...
                   <input type="hidden" id="dp" name="dp" value="<?php echo $dados->dp ?>"/>
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="fg-line form-group">
                                        <label>Data da aula</label>
                                        <input id="data" type="text" value="<?php echo formata_padrao_data($dados->data) ?>" class="form-control input-sm dataAula" data-toggle="datepicker" name="data" required="">
                                    </div>
                                </div>                                
                                <div class="col-sm-12">
                                    <div class="fg-line form-group">
    ...
    <script>
        ...
        function enviarPlan(){
            ...
            $.ajax({
               url: "services/planoAula.php",
               type: 'POST',
               data: {function: 'edit', id: id, professor: professor_id, dp: dp,
                        data: data, titulo: titulo, texto: texto},
            ...
            $.ajax({
                    ...
                    success: function(data){
                        swal({
                            ...
                            location.href='planoDisc?i=<?php echo $dados->dp ?>';
                        });                         
