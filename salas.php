    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                        ...
                        <div class="card-body card-padding">
                            <div class="row">
                                ...
                                <div class="list-group">
                                    ...
                                    <a class="list-group-item media" href="salaDetail?i=<?php echo $sala->id ?>">
                                        <div class="pull-left">
                                            <img class="lgi-img" src="img/curso.png" alt="">
                                        </div>
                                        <div class="media-body">
                                            <div class="lgi-heading"><?php echo $sala->nome ?></div>
                    ...
                    <div class="card-body">
                        <a href="salaNova" style="float: right" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Nova</a>
                    </div>
            </div>              
