                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="fg-line form-group">
                                        ...
                                        <input id="data" type="text" class="form-control input-sm dataAula" data-toggle="datepicker" name="data" required="">
                                    </div>
                                </div>                                
                                <div class="col-sm-12">
                                    <div class="fg-line form-group">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="planoDisc?i=<?php echo $disc_professor->id ?>" class="btn btn-link" data-dismiss="modal">Cancelar</a>
                                </div>                                    
               ...
               success:function(data){
                   if(data !== 'error'){
                        swal({
                            ...
                            location.href='planoDetail?i='+data;
                        });                        
                   }else{
                        swal({
