...
if(!empty($_GET)){
    $dados = listarTipoAvaliacao($_GET['i']);
    if($dados == "nenhum"){
...
<body>
    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
               <form class="formularioTipoAvaliacao" action="services/posts/nivel_posts.php" method="POST">
                    ...
                    <div class="card-body">
                        <a href="tiposAvaliacao" style="float: left" class="btn bgm-gray btn-icon-text"><i class="zmdi zmdi-arrow-back"></i> Voltar</a>
        ...
        <div class="modal fade" id="edit" role="dialog" aria-hidden="true" >
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="formularioTipoAvaliacao" action="services/tipoAvaliacao.php" method="POST">
                        ...
                        <div class="card">
                            <div class="card-body card-padding">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="fg-line form-group">
                                            <input type="text" class="form-control input-sm" name="descricao" placeholder="Nome" required="" value="<?php echo $dados->descricao ?>">                                                       
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function excl(id_nivel){
            $.ajax({
                    type: "POST",
                    data: {i:id_nivel, function:'remover'},
