...
if(!empty($_GET)){
    ...
    $cursos = listarCursos();
    $disciplinasProfessor = buscaDisciplinasPorProfessor($dados->id);
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content p-20">
                                    ...
                                    <div role="tabpanel" class="tab-pane animated fadeIn" id="tab-2">
                                        ...
                                        <a data-toggle="modal" href="#turma" style="float: right; margin-top: 45px" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Nova Turma</a>
                                    </div>
                                    
                                    <div class="modal fade" id="turma" role="dialog" aria-hidden="true" >
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form class="formularioTurma" action="services/disciplinaProfessor.php" method="POST">
                                                    ...
                                                    <input type="hidden" name="id_professor" value="<?php echo $dados->id ?>"/>
                                                    <div class="card">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">  
                                                                    <div class="fg-line form-group">
                                                                        ...
                                                                        <select style="padding: 6px; border: none; width: 100%" id="turmas" name="turma">
                                                                            <option selected="" disabled="" value="">SELECIONE</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-6">  
                                                                    <div class="fg-line form-group">
                                                                        ...
                                                                        <select style="padding: 6px; border: none; width: 100%" id="disciplinas" name="disc">
                                                                            <option selected="" disabled="" value="">SELECIONE</option>
                                                                        </select>
                                                                    </div>
                                                                </div>                                                                
