        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
               <form class="formMedia" method="POST" action="services/media.php">
                   ...
                   <input type="hidden" id="id" name="id" value="<?php echo $media->id ?>"/>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="fg-line form-group">
                                        ...
                                        <input id="data" name="nome" type="text" value="<?php echo $media->nome ?>" class="form-control input-sm" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="fg-line form-group">
                                        ...
                                        <input id="corte" name="corte" type="text" value="<?php echo moeda($media->corte) ?>" class="form-control input-sm" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="fg-line form-group">
                                        ...
                                        <select class="chosen" placeholder="Selecione o tipo" name="tipo">
                                                ...
                                                <option <?php if($media->tipo == "b"){?> selected="" <?php }?> value="b">Bimestral</option>
                                                <option <?php if($media->tipo == "a"){?> selected="" <?php }?> value="a">Anual</option>
                                        </select>
                                    </div>
                                </div>                                
                    ...
                    <div class="card">
                        <div class="list-group lg-odd-black">
                            ...
                            if($dados != "nenhum"){
                                ...
                                $valida = tipoAvaliacaoPorMedia($media->id, $dado->id);
                            ?>
                            
                            <div class="list-group-item media">
                                <div class="checkbox pull-left">
                                    <label>
                                        <input type="checkbox" class="matricula" <?php if($valida == "true"){?> checked <?php }?>
                                               id="<?php echo $dado->id ?>" name="tipos[]" value="<?php echo $dado->id ?>">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="medias" class="btn btn-link" data-dismiss="modal">Voltar</a>
                        </div>                        
