    ...
    <section id="main">
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="fg-line form-group">
                                        <input type="text" class="form-control input-sm" id="busca" placeholder="Nome" required="">
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <a href="disciplinaNova" style="float: right" class="btn bgm-black btn-icon-text"><i class="zmdi zmdi-plus"></i> Nova</a>
                    </div>
            </div>              
        </section>
    </section>
        ...
        $(function(){
            $("#busca").keyup(function () {
                $.ajax({
                    ...
                    type: 'POST',
                    data: {function: 'buscaInstDisciplina', busca: $("#busca").val(), id_curso: $("#curso").val()},
