...
<body>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">  
                                    <div class="fg-line form-group">
                                        ...
                                        <p><?php echo $dados->nome_nivel ?></p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="fg-line form-group">
                                        <label>Valor mensal</label>
                                        <p>R$ <?php echo moeda($dados->valor) ?></p>
                                    </div>
                                </div>                                 
                            </div>
                        </div>
                            ...
                            <div class="card-body card-padding">
                                <div class="row">
                                        ...
                                        <div class="fg-line form-group">
                                            ...
                                            <select class="chosen" placeholder="Selecione o nivel" name="nivel">
                                                    ...
                                                    foreach ($niveis as $nivel) {
                                                        ?>
                                                <option <?php if($dados->id_nivel == $nivel->id){?> selected="" <?php }?> value="<?php echo $nivel->id ?>"><?php echo $nivel->nome ?></option>
                                                        <?php
                                                    }
                                                    }else{
                                                        echo 'nenhum nivel';
                                    ...
                                    <div class="col-sm-6">
                                        <div class="fg-line form-group">
                                            <label>Valor mensal</label>
                                            <input type="text" value="<?php echo moeda($dados->valor) ?>" class="form-control input-sm" id="valora" name="valor" required="">
                                        </div>
                                    </div> 
    ...
    <script>
        ...
        function excl(id_curso){
            $.ajax({
                    type: "POST",
                    data: {i:id_curso, function:'remover'},
