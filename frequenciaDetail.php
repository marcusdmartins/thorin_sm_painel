...
if(!empty($_GET)){
    $frequencia = listarFrequencia($_GET['i']);
    $disc_professor = listaDisciplinaProfessor($frequencia->dp);
        ...
        <section id="content" style="margin-top: -15px">
           <div class="container">
               <form class="formFrequencia" method="POST" action="services/frequencia.php">
                   ...
                   <input type="hidden" id="id" name="id" value="<?php echo $frequencia->id ?>"/>
                   ...
                   <input type="hidden" id="id_turma" name="id_turma" value="<?php echo $dados->id ?>"/>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="fg-line form-group">
                                        <label>Data</label>
                                        <input id="data" name="data" type="text" value="<?php echo formata_padrao_data($frequencia->data) ?>" class="form-control input-sm dataAula" data-toggle="datepicker" name="data" required="">
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="list-group lg-odd-black">
                            ...
                            if($matriculas_alunos != "nenhum"){
                                foreach ($matriculas_alunos as $matricula){
                                    ...
                                    $presenca = frequenciaAlunoDP($frequencia->id, $aluno->id);
                            ?>
                            
                            <div class="list-group-item media">
                                <div class="checkbox pull-left">
                                    <label>
                                        <input type="checkbox" <?php if($presenca == "true"){?> checked <?php }?>
                                               class="matricula" id="<?php echo $matricula->id_pessoa ?>" name="alunos[]" value="<?php echo $matricula->id_pessoa ?>">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-link">Salvar alterações</button>
                            <a href="frequenciaDisc?i=<?php echo $disc_professor->id ?>" class="btn btn-link" data-dismiss="modal">Voltar</a>
                            <a href="#" class="btn btn-link delete">Excluir</a>
                        </div>                        
